...
if($_SESSION['cpf_adm']){
    ...
    require_once("../adm/head.php");
    include "../adm/menu_adm.php";
    include "../adm/navibar_adm.php";
    include "../footer.php";
 ...
 $inicio = ($limite_resultado * $pagina) - $limite_resultado;
    ...
    $query_usuarios = "SELECT * FROM local_atendimento WHERE CAST(cnes AS TEXT) LIKE '%$dado%' OR nome_fantasia LIKE '%$dado%'";
