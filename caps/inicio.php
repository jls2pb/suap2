        ...
        <tbody>
           ...
           <div class = "row">
            ...
            if ($pagina > 1) {
                ...
                echo "<a href='inicio.php?page=$pagina_anterior&cpf=$cpf_logado'><label style='font-size:30px;' title='Anterior'>&#8592</label></a> ";
            }
    
            if ($pagina < $qnt_pagina) {
                $proxima_pagina = $pagina + 1;
                echo "<a href='inicio.php?page=$proxima_pagina&cpf=$cpf_logado'><label style='font-size:30px;' title='Próximo'>&#8594</label></a> ";
            }
