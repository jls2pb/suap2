...
<form method = "POST" action = "edita_procedimento_adm.php">  
		...
		<div class="row">
                <div class="col">     
          	        <div class="form-outline mb-4">
                        <label class="form-label">Procedimento</label><br>
        ...
        <div class="row">
                    <div class="col">
                        <div class="form-outline mb-4">
                        <label class="form-label">Especificação</label><br>
                ...
                <div class="row">
                    <div class="col">
                        <label class="form-label">Data da Solicitação</label><br>
                         <input type="date" name = "d_solicitacao" class="form-control form-control-lg" value = "<?php echo $solicitacao ?>"/>
                    </div>
                    <div class="col">
                        <label class="form-label">Data de Entrada(Cadastro)</label><br>
                    ...
                    <div class="col">
                        <label class="form-label">Data do Agendamento</label><br>
                ...
                <div class="row">
                    <div class="col">
                        <label class="form-label">Local do Agendamento</label><br>
