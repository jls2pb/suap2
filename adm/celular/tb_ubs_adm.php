...
<table class="table table-responsive  table-striped">
		...
		<a class="btn text-white btn-primary" href="edita_ubs.php?id=<?php echo $d['id_uaps'];?>" role="button"><b>EDITAR</b></a>
            ...
            if ($pagina > 1) {
                ...
                echo "<a href='tb_ubs_adm.php?page=$pagina_anterior&cpf=$cpf_logado' class='btn'><label style='font-size:30px;' title='Anterior'><span aria-hidden='true'>&laquo;</span></label></a> ";
            }
    
            if ($pagina < $qnt_pagina) {
                $proxima_pagina = $pagina + 1;
                echo "<a href='tb_ubs_adm.php?page=$proxima_pagina&cpf=$cpf_logado' class='btn'><label style='font-size:30px;' title='Próximo'><span aria-hidden='true'>&raquo;</span></label></a> ";
            }
