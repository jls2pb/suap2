...
<form method = "POST" action = "registro_profissional.php">  
    ...
    <input type="hidden" name="session" value="<?php echo $_SESSION['cpf_adm']; ?>">
    <input type="number" name="tempo" class="form-control form-control-lg" id="tempo" pattern="^(0?[1-9]|[1-5][0-9]|60)$" placeholder = "Tempo de 1 a 60 minutos" title="Digite um número de 1 a 60" style="font-size:12px;">
</div>
