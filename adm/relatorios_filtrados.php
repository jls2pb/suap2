...
if (isset($_SESSION['cpf'])) {
    ...
    if (isset($_POST['procedimento'])) {
        ...
        if (isset($_POST['procedimento']) && $_POST['procedimento'] == 'entrada') {
            ...
            $query2 = "SELECT COUNT(*) AS quantidade_entrada FROM procedimentos WHERE  data_de_entrada_cadastro BETWEEN :dataInicio AND :dataFim AND cod IN (SELECT procedimento FROM agendamento)";
