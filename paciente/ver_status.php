...
$query_procedimento = "SELECT * FROM agendamento WHERE procedimento = :cod";
$result_procedimento = $conexao->prepare($query_procedimento);
$result_procedimento->bindParam(':cod', $cod, PDO::PARAM_STR);
...
<table style="" class="table table-striped table-bordered table-sm table-responsive">
    ...
    <tbody>
        ...
        <?php
            ...
            echo "<p style='color: #f00;'>Erro: Nenhum agendamento encontrado!</p>";
            }  
        }
        else {
