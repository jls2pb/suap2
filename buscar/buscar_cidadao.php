...
if (isset($_GET['term'])) {
    ...
    if (strlen($term) >= 3) {
        ...
        $sql = "SELECT DISTINCT ON (no_cidadao, nu_cpf, nu_cns) no_cidadao, nu_cpf, nu_cns, dt_nascimento, no_mae, nu_telefone_celular, nu_telefone_contato  FROM tb_cidadao WHERE no_cidadao LIKE :term LIMIT 5";
