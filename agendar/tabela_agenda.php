...
$nome_profissional = $profissional['nome'];
            ...
            <a class="btn text-white" style="background-color: #66a7ff; font-size:10px;" href = "form_edita_agenda.php?id=<?php echo $d["id_agenda"];?>" role="button">EDITAR</a>
                  <a class="btn text-white btn-danger" onclick="confirmarExclusao(<?php echo $d['id_agenda'] ; ?>)" role="button" style="font-size:10px;">EXCLUIR</a>
            </td>
            </tr>
            <?php
                    }
            ...
            if ($pagina < $qnt_pagina) {
                ...
                echo "<a class='btn' style='color: white; background-color: #66a7ff;' href='tabela_agenda.php?page=$qnt_pagina&cpf=$cpf_logado'>Última</a> ";
            ?></div> <?php
            }
