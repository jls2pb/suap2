...
<form method="POST" action="registro_procedimento.php">
    <div class="col-4">
        <div class="form-outline mb-4">
            ...
            <input type="text" name="paciente" class="form-control form-control-lg" id="paciente_input" list="paciente_list" oninput="handleInput(event)">
...
<script>
    ...
    function atualizarProcedimentos(cod) {
        ...
        $.ajax({
            url: 'buscar_procedimentos.php', // Substitua pelo URL correto para buscar procedimentos com base no código
            type: 'GET',
            data: { cod: cod },
            dataType: 'json',
            success: function (data) {
                ...
                data.forEach(function (procedimento) {
                    $('#procedimento').append('<option value="' + procedimento.nome_procedimento + '">' + procedimento.nome_procedimento + '</option>');
                });
            }
        });
    }
