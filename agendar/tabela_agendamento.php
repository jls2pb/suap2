...
?>
            ...
            <td class = "text-center">
                  ...
                  <a class="btn text-white bg-info" style="font-size:10px;" href = "boleto.php?id=<?php echo $d["id_agendamento"];?>" role="button">BOLETO</a>
                  <a class="btn text-white btn-danger" onclick="confirmarCancelamento(<?php echo $d['id_agendamento'] ; ?>)" role="button" style="font-size:10px;">DESMARCAR</a>
                </td>
            </tr>
            <?php
                        }
