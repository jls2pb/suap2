...
<table class="table table-striped table-compact" style="font-size:12px;">
        ...
        <tbody>
            ...
            <td>
		        ...
		        <a class="btn text-white btn-primary" href="edita_procedimentos.php?id=<?php echo $d['id_procedimento'];?>" role="button" style="font-size:10px;"><b>EDITAR</b></a>
            </td>
            <td>
		        <a class="btn text-white btn-danger" onclick="confirmarExclusao(<?php echo $d['id_procedimento']; ?>)" role="button" style="font-size:10px;"><b>EXCLUIR</b></a>
